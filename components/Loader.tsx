...
export default function Loader() {
    ...
    return (
        <div ref={elementRef} className={` invisible z-50 top-0 left-0 flex w-screen dark:bg-primary2 h-screen loader banner flex justify-center items-center overflow-hidden`}>
