...
export default function Loader() {
    ...
    useEffect(() => {
        ...
        tl.to('.loader', { autoAlpha: 1 })
                ...
                .to('.bracket',{ x: "-20vw", yoyo: true, duration: 1.2, ease: "power2.inOut" })
                .to('.bracket',{ x: "0", yoyo: true, duration: 1.2, ease: "power2.inOut" })

                gsap.timeline({delay: 3}).fromTo('.vince', { x: 80, autoAlpha: 0, duration: 2 }, { x: 0, autoAlpha: 1 }, 1)
                .to('.vince', { autoAlpha: 0, duration: 1.5})
    ...
    return (
        <div className="invisible z-50 top-0 left-0 flex w-screen h-screen loader banner flex justify-center items-center">
