...
export default function TechStack() {
    return (
        <div className="py-24">
            ...
            <ul className="flex flex-wrap justify-around md:justify-center md:w-7/12 md:mx-auto text-base mt-8">
                <li className="w-24 md:w-48 my-6 mx-2 inline-flex  items-center justify-center">
